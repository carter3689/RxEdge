...
function initSlideShow() {
	jQuery('.visual .slideshow').fadeGallery({
		...
		onInit: function(self){
			...
			var textBlock = jQuery('.visual .text-box');
			var win = jQuery(window);
			var visual = jQuery('.visual');
			var visualSlide = jQuery('.visual .container .slide img');
			var timer;
			...
			function resizeHandler(){
				...
				timer = setTimeout(function() {
					...
					var textHeight = textBlock.outerHeight(true);

					self.gallery.css({
						top: top,
						height: visual.outerHeight(true) - top
					});
				}, 400);
			}
			resizeHandler();
	...
	jQuery('.wrap-slideshow').fadeGallery({
		slides: '.slide-box',
		btnPrev: 'a.btn-prev',
		btnNext: 'a.btn-next',
		generatePagination: '.pagination',
...
function initBgParallax() {
	jQuery('.slide').parallaxBlock({
		image: 'img'
	});
	jQuery('.slide-box').parallaxBlock({
		image: 'img'
	});
